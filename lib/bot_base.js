    ...
    switch (commandObj.command) {
        ...
        case 'commands':
            ...
            if (spkr.isMod || spkr.isOwner || spkr.isJBIRD) {
                ...
                + "autobop(true/false), autobopstat, setlimit X, setdeckcheck(true/false), setdecklimit X, songlimitstat, decklimitstat, current, lame, dj, theme X, "
        ...
        case 'afkcheckstat':
            if (spkr.isMod || spkr.isOwner || spkr.isJBIRD) {
                botSpeak(where, 'afkcheck set to: ' + config.afkCheck + " escorting at " + config.afkMin + " minutes.", commandObj.pmID);
            } else {
                botSpeak(where, "I'm sorry that is a Mod command.", commandObj.pmID);
            }
            break;
